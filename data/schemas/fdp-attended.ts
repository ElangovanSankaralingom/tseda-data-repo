...
const fields = [
  ...
  { key: "coParticipants", label: "Co-Participants", kind: "array", required: false, collaborates: true },
  ...
  { key: "fundingAmount", label: "Funding Amount", kind: "number", required: false, stage: 1, format: "currency" },
