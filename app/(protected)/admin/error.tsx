  ...
  return (
    <div className="mx-auto flex min-h-[50vh] w-full max-w-md flex-col items-center justify-center px-4 py-10">
      <div className="w-full rounded-xl border border-[var(--color-glass-border)] bg-[var(--color-glass-bg)] p-8 text-center shadow-sm">
        ...
        <h2 className="mt-4 text-base font-medium text-[var(--color-text-secondary)]">Admin action failed</h2>
        <p className="mt-2 text-sm text-[var(--color-text-secondary)]">{toUserMessage(error)}</p>
        <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
          <button
            type="button"
            onClick={reset}
            className="inline-flex h-10 items-center justify-center rounded-lg border border-[var(--color-glass-border)] bg-[var(--color-glass-bg)] px-4 text-sm font-medium text-[var(--color-text-secondary)] transition hover:bg-[var(--color-dropdown-hover)]"
          >
            Try again
          </button>
          <Link
