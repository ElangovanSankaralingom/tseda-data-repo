...
export function FdpConductedPage({
  ...
  async function saveDraftChanges(options?: {
    ...
    return runSaveDraftOrchestration<FdpConducted>({
      intent,
  ...
  async function generateEntry() {
    await runGenerateEntryOrchestration<FdpConducted>({
      saveLockRef,
                            ...
                            <div className="flex items-start justify-between gap-3">
                              <div className="min-w-0">
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  />
                                  <Link href={entryDetail("fdp-conducted", entry.id)} className="text-base font-semibold hover:opacity-80">
                              ...
                              {!(activeEntryId && entry.id === activeEntryId) ? (
                                <div className="flex shrink-0 flex-col items-end gap-2">
                                  <div className="flex items-center gap-2">
                                    <MiniButton onClick={() => router.push(entryDetail("fdp-conducted", entry.id))}>
                                      View
                                    </MiniButton>
                                    <MiniButton
                                      onClick={() => {
