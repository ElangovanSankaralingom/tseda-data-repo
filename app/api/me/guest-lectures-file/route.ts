/**
 * @deprecated Use /api/me/guest-lectures/file instead.
...
export async function POST(request: Request) {
  ...
  try {
    enforceRateLimitForRequest({
      ...
      action: "upload.guest-lectures.post",
    ...
    if (file instanceof File) {
      assertUploadMetadataInput(
        ...
        "guest-lectures upload request"
      );
    } else {
      assertUploadMetadataInput({ email, recordId, slot }, "guest-lectures upload request");
    }
...
export async function DELETE(request: Request) {
  ...
  try {
    enforceRateLimitForRequest({
      request,
      userEmail: authorizedEmail,
      action: "upload.guest-lectures.delete",
      options: RATE_LIMIT_PRESETS.uploadOps,
    });
    ...
    assertUploadMetadataInput(
      ...
      "guest-lectures upload delete request"
    );
