  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className={`absolute -right-0.5 -top-0.5 flex items-center justify-center rounded-full bg-red-500/15 font-bold text-white ring-2 ring-[var(--color-glass-bg)] animate-subtle-pulse ${
