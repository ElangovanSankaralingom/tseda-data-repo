...
export default function NetworkStatus() {
  ...
  return (
    <div className="fixed bottom-4 inset-x-4 z-50 flex items-center gap-2 rounded-xl border border-[var(--color-status-error-border)] bg-[var(--color-status-error-bg)] backdrop-blur-xl px-4 py-2.5 text-sm font-medium text-[var(--color-status-error)] shadow-lg shadow-black/20 sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2 sm:max-w-md animate-slide-in-right">
