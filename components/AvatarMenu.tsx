    ...
    <div ref={rootRef} className="relative">
      <div className="flex items-center gap-2">
        {showName && displayName ? (
          <span className="hidden text-sm font-medium text-[var(--color-text-primary)] sm:inline">{displayName}</span>
        ) : null}
        <button
        ref={buttonRef}
        type="button"
      ...
      {open ? (
        ...
        >
            ...
            className="block rounded-lg px-3 py-2 text-sm transition hover:bg-[var(--color-dropdown-hover)]"
          >
            My Account
          </Link>
          <button
            ...
            className="block w-full rounded-lg px-3 py-2 text-left text-sm transition hover:bg-[var(--color-dropdown-hover)]"
          >
            Sign Out
          </button>
        </div>
