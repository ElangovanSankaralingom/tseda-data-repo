      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-8 text-center">
          ...
          <div className="mt-5 flex items-center justify-center gap-3">
            <button type="button" disabled className="rounded-xl bg-slate-100 px-5 py-2.5 text-sm font-medium text-slate-500 opacity-50 cursor-not-allowed">
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50/30 p-6">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            <button
              type="button"
              disabled
              className="rounded-xl border border-slate-300 bg-white px-5 py-2.5 text-sm font-medium text-slate-500 opacity-50 cursor-not-allowed"
