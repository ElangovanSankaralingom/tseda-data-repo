    ...
    <SectionCard title={t("account.uploadsTitle")} subtitle={t("account.uploadsSubtitle")}>
      <div className="space-y-4">
        {(
          ...
          return (
            <div key={docType} className="rounded-xl border border-[var(--color-glass-border)] p-4 space-y-3">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  {meta ? (
                    ...
                    <div className="mt-1 text-xs text-[var(--color-text-muted)]">No file uploaded.</div>
                  )}
                  ...
                  {busy ? (
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="text-xs text-[var(--color-text-muted)]">{pct}% uploading…</div>
                    </div>
                  ) : null}
                  ...
                  {meta ? (
                    <>
                      <a
                        href={meta.url}
                        target="_blank"
                        className="px-3 py-2 rounded-lg text-sm border border-[var(--color-glass-border)] hover:bg-[var(--color-glass-hover)] transition"
                      >
                        Preview
                      </a>
