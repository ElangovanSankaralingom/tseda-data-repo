...
export const LIGHT_BASE: ThemeTokens = {
  ...
  "--color-primary-muted": "#EDF6DB",
  "--color-primary-hover": "#3F6212",
  "--color-accent": "#65A30D",
  "--color-accent-light": "#F1F8E3",
  "--color-header-bg": "rgba(250, 251, 253, 0.74)",
  "--color-header-bg-scrolled": "rgba(250, 251, 253, 0.90)",
  "--color-header-text": "#161B28",
  "--color-sidebar-bg": "#FAFBFD",
  "--color-sidebar-text": "#4A5264",
  "--color-sidebar-active-bg": "#EDF6DB",
  "--color-sidebar-active-text": "#3F6212",
  "--color-sidebar-hover-bg": "#EFF1F6",
  ...
  "--color-body-bg": "#EDEFF4",
  "--color-card-bg": "#FFFFFF",
  "--color-card-border": "#DDE1E9",
  "--color-text-primary": "#141926",
  "--color-text-secondary": "#454D5F",
  "--color-text-muted": "#6F7789",
  "--color-text-tertiary": "#5B6375",
  "--color-text-placeholder": "#7B8396",
  "--color-input-bg": "#FFFFFF",
  "--color-input-border": "#C3CAD7",
  "--color-input-focus-ring": "#65A30D",
  "--color-badge-bg": "#E4F0CC",
  ...
  "--color-divider-strong": "#C9CFDB",
  "--color-border-subtle": "#E5E8EF",
  "--color-border-default": "#D6DBE4",
  "--color-border-strong": "#AEB6C6",
  "--color-icon-active": "#141926",
  "--color-icon-default": "#454D5F",
  "--color-icon-muted": "#6F7789",
  "--color-surface-raised": "#FFFFFF",
  "--color-surface-inset": "#E9ECF2",
  "--color-surface-panel": "#FFFFFF",
  "--color-surface-panel-raised": "#FFFFFF",
  "--color-surface-panel-tile": "#F0F2F7",
  "--color-surface-inset-deep": "#DCE0E9",
  "--color-dropdown-bg": "#FFFFFF",
  "--color-dropdown-hover": "#EFF1F6",
  "--color-toast-bg": "#FFFFFF",
  "--color-modal-overlay": "rgba(16, 20, 32, 0.42)",
  "--color-modal-bg": "#FFFFFF",
  "--color-skeleton-base": "#E5E8EF",
  "--color-skeleton-shine": "#F1F3F8",
  "--color-header-tint": "rgba(77, 124, 15, 0.05)",
  "--color-gradient-from": "#F8FAFD",
  "--color-gradient-to": "#E9ECF3",
  "--color-band-from": "#1E2536",
  "--color-band-to": "#131826",
  ...
  "--color-glass-border": "rgba(22, 27, 40, 0.08)",
  "--color-glass-hover": "rgba(22, 27, 40, 0.04)",
