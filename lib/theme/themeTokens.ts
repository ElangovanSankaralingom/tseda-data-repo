...
export const LIGHT_BASE: ThemeTokens = {
  ...
  "--color-card-border": "#E2E5EC",
  "--color-text-primary": "#161B28",
  "--color-text-secondary": "#4A5264",
  "--color-text-muted": "#9AA1B2",
  "--color-text-tertiary": "#6E7689",
  "--color-text-placeholder": "#9AA1B2",
  "--color-input-bg": "#FFFFFF",
  "--color-input-border": "#D3D8E2",
  ...
  "--color-divider": "#E5E8EF",
  "--color-divider-strong": "#D4D9E2",
  "--color-border-subtle": "#E9ECF1",
  "--color-border-default": "#DEE2EA",
  "--color-border-strong": "#C6CCD8",
  "--color-icon-active": "#161B28",
  "--color-icon-default": "#4A5264",
  "--color-icon-muted": "#9AA1B2",
