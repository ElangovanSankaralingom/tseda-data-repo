...
export /* LIGHT palette fg + status tokens hold WCAG 2.1 AA (>=4.5:1) on their own
   tinted chip backgrounds over white — verified by tests/wiring/contrastGuard.
   Darken-only edits; never lighten below the guard. */
const LIGHT_BASE: ThemeTokens = {
  ...
  "--color-text-on-accent-muted": "rgba(255, 255, 255, 0.85)",
...
export const COLOR_PALETTES: Record<ColorPalette, Partial<ThemeTokens>> = {
  ...
  "deep-ocean": {
    ...
    "--color-band-from": "#06B6D4",
    "--color-band-to": "#22D3EE",
    "--color-accent": "#06B6D4",
  ...
  "carbon-violet": {
    ...
    "--color-band-from": "#8B5CF6",
    "--color-band-to": "#A78BFA",
    "--color-accent": "#8B5CF6",
  ...
  "obsidian-amber": {
    ...
    "--color-band-from": "#F59E0B",
    "--color-band-to": "#FBBF24",
    "--color-accent": "#F59E0B",
